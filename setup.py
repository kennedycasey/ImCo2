...
def test_object_count():
    ...
    for file in files:
        ...
        for line in range(len(content)):
            if 'object_count' in content[line]:
        ...
        new_content = []
        for line in content:
            if line not in removals or ('@property' in line and '@property' not in new_content[len(new_content)-1]) or 'self.root' in line or 'bg' in line:
